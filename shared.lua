...
function shared_init()
  local colors = {
    ...
    red2 = ColorRamp(Color'#b3172d', 0.025),
    ...
    brown = ColorRamp(Color'#bb6f07', 0.025),
    brown2 = ColorRamp(Color'#7e5419', 0.025),
    orange = ColorRamp(Color'#f07021', 0.025),
    blue = ColorRamp(Color'#019bd6', 0.025),
    blue2 = ColorRamp(Color'#4778ba', 0.025),
    blue3 = ColorRamp(Color'#7aa0ca', 0.025),
    green = ColorRamp(Color'#8bbf40', 0.025),
    green2 = ColorRamp(Color'#598718', 0.025),
    purple = ColorRamp(Color'#8e559e', 0.025),
    purple2 = ColorRamp(Color'#63428c', 0.025),
  }
...
global_text_tags = {
  ...
  red2 = TextTag{draw = function(c, i, text) graphics.set_color(red2[0]) end},
  ...
  green2 = TextTag{draw = function(c, i, text) graphics.set_color(green2[0]) end},
  purple = TextTag{draw = function(c, i, text) graphics.set_color(purple[0]) end},
  purple2 = TextTag{draw = function(c, i, text) graphics.set_color(purple2[0]) end},
  brown = TextTag{draw = function(c, i, text) graphics.set_color(brown[0]) end},
  brown2 = TextTag{draw = function(c, i, text) graphics.set_color(brown2[0]) end},
  ...
  blue3 = TextTag{draw = function(c, i, text) graphics.set_color(blue3[0]) end},
  ...
  purple5 = TextTag{draw = function(c, i, text) graphics.set_color(purple[5]) end},
  purplem5 = TextTag{draw = function(c, i, text) graphics.set_color(purple[-5]) end},
  purple25 = TextTag{draw = function(c, i, text) graphics.set_color(purple2[5]) end},
  purplem25 = TextTag{draw = function(c, i, text) graphics.set_color(purple2[-5]) end},
  greenm5 = TextTag{draw = function(c, i, text) graphics.set_color(green[-5]) end},
  green2m5 = TextTag{draw = function(c, i, text) graphics.set_color(green2[-5]) end},
  green5 = TextTag{draw = function(c, i, text) graphics.set_color(green[5]) end},
  green25 = TextTag{draw = function(c, i, text) graphics.set_color(green2[5]) end},
  ...
  blue35 = TextTag{draw = function(c, i, text) graphics.set_color(blue3[5]) end},
  blue3m5 = TextTag{draw = function(c, i, text) graphics.set_color(blue3[-5]) end},
  ...
  brown5 = TextTag{draw = function(c, i, text) graphics.set_color(brown[5]) end},
  brownm5 = TextTag{draw = function(c, i, text) graphics.set_color(brown[-5]) end},
  brown25 = TextTag{draw = function(c, i, text) graphics.set_color(brown2[5]) end},
  brown2m5 = TextTag{draw = function(c, i, text) graphics.set_color(brown2[-5]) end},
  red5 = TextTag{draw = function(c, i, text) graphics.set_color(red[5]) end},
  redm5 = TextTag{draw = function(c, i, text) graphics.set_color(red[-5]) end},
  red25 = TextTag{draw = function(c, i, text) graphics.set_color(red2[5]) end},
  red2m5 = TextTag{draw = function(c, i, text) graphics.set_color(red2[-5]) end},
